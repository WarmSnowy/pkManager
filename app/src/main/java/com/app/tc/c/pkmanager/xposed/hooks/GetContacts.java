...
public class GetContacts extends BaseHook {
    public static final String TAG = "GetContacts";
    ...
    private static class QueryMethodHook extends XC_MethodHook {
        ...
        protected void afterHookedMethod(MethodHookParam param) throws Throwable {
            ...
            if (cursor == null || uri == null)
                return;
            if (uri.getAuthority().equals("com.android.blockednumber")
                    || uri.getAuthority().equals("icc")
                    || uri.getAuthority().equals("com.android.contacts")) {
